...
@Slf4j
@Service("zksync2ChainWithdrawEventLogHandler")
public class Zksync2ChainWithdrawEventLogHandler extends EventLogHandler {
    ...
    public void handleHash(AbstractEventLogParam param) {
        ...
        if (zkNetEvent == null) {
            log.warn("withdraw Event has no Tx record, log:{}", param);
            return;
        }
